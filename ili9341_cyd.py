...
class Display(object):
    ...
    def __init__(self, spi, cs, dc, bl, width=240, height=320, rotation=0):
        """Initialize OLED.
        ...
        if implementation.name == 'circuitpython':
            ...
            self.backlight_on = self.backlight_on_mpy
            self.backlight_off = self.backlight_off_mpy
